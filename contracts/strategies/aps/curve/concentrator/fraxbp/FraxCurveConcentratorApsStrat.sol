...
import "../CurveConcentratorApsStratBase.sol";
import "../../../../../interfaces/IZunamiVaultV1.sol";
import "../../../../../interfaces/IZunamiStableVault.sol";
import "../../../../interfaces/ICurvePool2.sol";

//import "hardhat/console.sol";

abstract contract FraxCurveConcentratorApsStrat is CurveConcentratorApsStratBase {
    ...
    IZunamiVaultV1 public immutable zunamiPool;
    ...
    {
        zunamiPool = IZunamiVaultV1(zunamiPoolAddr);
        ...
        returns (uint256 poolLpAmount)
    {
        ...
        try vault.deposit(pid, address(this), poolLpAmount) {} catch {}
    }
        ...
        returns (uint256)
    {
        ...
        uint256 removingCrvLps = (getVaultBalance() *
        ...
        )
    {
        ...
        removingCrvLps = (getVaultBalance() *
        userRatioOfCrvLps) / 1e18;
