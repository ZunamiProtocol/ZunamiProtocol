...
contract Zunami is ERC20, Pausable, AccessControl {
    ...
    event Deposited(address indexed depositor, uint256 depositedValue, uint256[POOL_ASSETS] amounts, uint256 lpShares, uint256 pid);
    ...
    function processSuccessfulDeposit(
        ...
        emit Deposited(user, depositedValue, depositedTokens, lpShares, defaultDepositPid);
    ...
    function processSuccessfulWithdrawal(
        ...
        emit Withdrawn(user, tokenAmounts, lpShares, withdrawalType, tokenIndex, defaultWithdrawPid);
    }
